                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <a class="btn btn-primary " href="{{ route('result.index') }}">Results</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($admitCard->image == null)
                                                    <a href="{{ route('admitCard.upload_image', $admitCard->id) }}"
                                                ...
                                                @else
                                                    <a href="{{ route('admitCard.upload_image', $admitCard->id) }}"
                                                        ...
                                                        <img height="50"
                                                            src="{{ asset('uploads/images/students/thumbnail/' . $admitCard->image) }}"
                                                            alt="{{ $admitCard->image }}">
                                                    </a>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a href="{{ route('admitCard.edit', $admitCard->id) }}"
