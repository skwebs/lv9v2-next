                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name', $admitCard->name) }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="aadhaar" type="number"
                                    ...
                                    value="{{ old('aadhaar', $admitCard->aadhaar) }}" pattern="^[0-9]{12}$" autocomplete="aadhaar">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="tel" class="form-control @error('mobile') is-invalid @enderror"
                                    value="{{ old('mobile', $admitCard->mobile) }}" name="mobile" pattern="^[6-9][0-9]{9}$" required
                                    autocomplete="tel">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text"
                                    ...
                                    value="{{ old('address', $admitCard->address) }}" required autocomplete="address">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="roll" type="number" class="form-control @error('roll') is-invalid @enderror"
                                    value="{{ old('roll', $admitCard->roll) }}" name="roll" pattern="^[0-9]{2}$" required
                                    autocomplete="roll">
