        ...
        <div style="width: 735px" height="518" class="card admit-card mx-auto border">
            <div class="card-body">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <table width="700">
                                <tr>
                                    <td width="80">
                                        <img height="80" src="{{ asset('images/static/ama300.webp') }}"
                                            alt="" srcset="" />
                                    </td>
                                    <td>
                                        ...
                                        <p class="text-center my-0 ">
                                            Run and managed by <strong>AnitaBindeshwar Foundation</strong> (Companies
                                            Act
                                            2013).
                                        </p>
                                    ...
                                    <td width="80">
                                        <img height="80" src="{{ asset('images/static/bbbp300.webp') }}"
                                            alt="" srcset="" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="text-center">
                            ...
                            {!! QrCode::size(140, 140)->generate(
                                "Name: $admitCard->name, Class: $admitCard->class, Roll: $admitCard->roll, Session: 2021-22",
                            ) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <table class="table table-borderless">
                                            <tr>
                                                <td width="100">
                                                    <img class="border border-dark" height="145"
                                                        src="@if ($admitCard->image == null) {{ asset('images/static/paste-image.webp') }} @else {{ asset('uploads/images/students/' . $admitCard->image) }} @endif "
                                                        alt="{{ $admitCard->image }}" />

                                                    @if ($admitCard->image != null)
                                                        <img class="seal-on-pic"
                                                            src="{{ asset('images/static/ama_seal300.webp') }}">
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table width="570" class="text-center">
                                <tr>
                                    <td> Principal Seal & Sign
                                        <img class="principal-seal"
                                            src="{{ asset('images/static/principal_seal400.webp') }}">
                                        <img class="principal-sign"
                                            src="{{ asset('images/static/principal_sign300.webp') }}">
                                    </td>
                                    <td>
                                        <img class="exam-ctrl" src="{{ asset('images/static/chandani_roy512.webp') }}">
                                        Exam Controller
                                    </td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                ...
                <div class="site text-center">
                    <div>For more info log on <a href="https://anshumemorial.in">www.anshumemorial.in</a> or write us on
                        <a href="mailto:contact@anshumemorial.in">contact@anshumemorial.in</a>
                    </div>
                </div>
