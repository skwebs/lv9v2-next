        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav">
                    ...
                    <li class="nav-item"><a href="javascript:void(0)" class="nav-link" id="hinBtn">हिंदी में पढ़ें।</a>
                    </li>
                </ul>
                <ol id="eng">
                    ...
                    <li>If you have any problem in viewing the result then <a href="https://wa.me/919973757920">click
                            here</a> to whatsapp.
                </ol>
                <ol id="hin">
                    ...
                    <li>अगर आपको रिजल्ट देखने में कोई परेशानी हो तो व्हाट्सएप करने के लिए <a
                            href="https://wa.me/919973757920">यहाँ क्लिक करें</a>।</li>
                </ol>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            CLS.on('change', function() {
                ...
                $('#select-roll').html('');
                $.ajax({
                    url: '{{ route('student.get_student_rolls') }}',
                    type: 'post',
                    data: {
                        _token: '{{ csrf_token() }}',
                        stu_class: CLS.val()
            ...
            function roll() {
                ...
                $("#select-roll").on('change', function() {
                    ...
                    let w = window.open('{{ url('student/') }}/' + resultId + '?_token={{ csrf_token() }}',
