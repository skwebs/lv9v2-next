...
<html lang="en">
  ...
  $qr="";
  $qr = <<<QRDATA
  "Name: {$r->admitCard->name}, Father's Name: {$r->admitCard->father}, Mother: {$r->admitCard->mother},
  Session: {$r->session},
          ...
          <table class="mx-auto px-2" style="width: 100%;">
            <tr>
              <td style="width:75px;padding-left:10px">
                <img class="float-end" width="75px" height="75px" src="{{asset('/images/static/ama300.webp')}}" alt="" srcset="" />
              </td>
              <td style="width: 100%">
              ...
              <td style="width:75px; padding-right:10px">
                <img class="float-start" width="75px" height="75px" src="{{asset('/images/static/bbbp300.webp')}}"  alt="" srcset="" />
              </td>
            </tr>
          </table>
        </td>
          ...
          <table class="table table-sm table-borderless table-borderless ">
            <tr>
              ...
              <td style="p-0" rowspan="5" width="150">
                <img class="border border-dark" width="100%" src="{{asset('uploads/images/students/'.$r->admitCard->image)}}">
              </td>
            </tr>
            <tr>
              <th>Father's Name</th>
          ...
          <table class="table table-sm table-borderless w-100">
            <tr>
              ...
              @endif
                  ...
                  <tr>
	                  <td class="text-start" colspan="6" ><strong>Extra Activity (Drawing)</strong> Marks: <strong>{{$r->marks->drawing}}</strong> &nbsp;| Grade: <strong>{{ res($r->marks->drawing)['g']}}</strong></td>
                  </tr>
                    ...
                    <td width="100%" class="d-flex justify-content-center">
                      <table class="text-center p-2" width="160">
                        <tr class="bg-success text-center fw-bold bg-success text-white">
                          ...
                          <td>:</td>
                          <td class="pe-2 py-2">{{ res(($r->total*100)/$r->full_marks)['g'] }}</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
        ...
        <td class="align-bottom"  style="height:185px;position:relative;">
	        <table class="table table-sm table-borderless text-center" >
		        <tr>
			        ...
			        <td width="25%" ></td>
			        <td width="25%" ><img class="exam-ctrl"  src="{{asset('/images/static/chandani_roy512.webp')}}" ></td>
			        <td width="25%" >
