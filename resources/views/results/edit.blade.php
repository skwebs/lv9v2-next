                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row" method="POST"
                            action="{{ route('result.update', ['result' => $result->id, 'class' => $stu->class, 'roll' => $stu->roll, 'session' => '2021-22', 'redirect_to' => url()->previous()]) }}"
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="full_marks" type="number"
                                    ...
                                    value="{{ old('full_marks', $result->full_marks) }}" required readonly>
