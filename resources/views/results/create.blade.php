                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex justify-content-between">
                            <span><strong>{{ $stu->name }}</strong> class <strong>{{ $stu->class }}</strong> roll no.
                                <strong>{{ $stu->roll }}</strong></span>
                        ...
                        <form class="row" method="POST"
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="maths" type="number"
                                    ...
                                    value="{{ old('maths') }}" required autofocus>
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="hindi" type="number"
                                    ...
                                    value="{{ old('hindi') }}" autofocus required>
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="english" type="number"
                                    ...
                                    value="{{ old('english') }}" required autofocus>
                               ...
                               {{-- Science --}}
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="science" type="number"
                                        ...
                                        placeholder="Science" min="0" max="80" value="{{ old('science') }}"
                                ...
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="science_oral" type="number"
                                        ...
                                        value="{{ old('science_oral') }}" name="science_oral" pattern="^[0-9]{2}$"
                                        required>
                               ...
                               {{-- sst --}}
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="sst" type="number"
                                        ...
                                        placeholder="S.St" min="0" max="80" value="{{ old('sst') }}"
                                        name="sst" required>
                                ...
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="sst_oral" type="number"
                                        ...
                                        value="{{ old('sst_oral') }}" name="sst_oral" pattern="^[0-9]{2}$" required>
                                ...
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="computer" type="number"
                                        ...
                                        value="{{ old('computer') }}" required autocomplete="computer">
                                ...
                                <div class="mb-3 col-4 col-md-3">
                                    ...
                                    <input id="gk" type="number"
                                        ...
                                        value="{{ old('gk') }}" required autocomplete="gk">
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="drawing" type="number"
                                    ...
                                    value="{{ old('drawing') }}" autocomplete="bday" required>
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="total" type="number"
                                    class="form-control @error('total') is-invalid @enderror" placeholder="Total Marks"
                                    name="total" value="{{ old('total') }}" required readonly>
                            ...
                            <div class="mb-3 col-4 col-md-3">
                                ...
                                <input id="full_marks" type="number"
                                    ...
                                    placeholder="Full Marks" name="full_marks" value="{{ old('full_marks') }}" required
                                    readonly>
